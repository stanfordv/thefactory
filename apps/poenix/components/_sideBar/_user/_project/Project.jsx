...
import generalize_only from '../../../generalize_only_store.js.js';
    ...
    >
      ...
      >
        ...
        {!project ? (
          ...
          <span>
            <button className="link" onClick={(e) => zeroProject()}>
              {project}
            </button>
          </span>
        )}
      ...
      <button>Expand all (not implimented)</button>
      {project != '' ? <SelectedArc user={user} project={project} /> : ''}
    </div>
  );
}
