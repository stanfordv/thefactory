...
import AddArc from './_selectedDestNode/_addArc/AddArc.jsx.js';
      ...
      {selectedArc.get().arcID != '' ? (
        <>
          ...
          <SelectedSourceNode
            user={user}
            project={project}
            sourceNodeString={selectedArc.get().sourceID}
          />
          <SelectedDestNode
            user={user}
            project={project}
            nodeString={selectedArc.get().destID}
          />
          <ChangeNodeString
            user={user}
            project={project}
        ...
        <>
          ...
          <AddArc
            ...
            project={project}
            sourceString=""
            label="Add project arc:"
          />
          <AddArc
            user={user}
            project={project}
            sourceString="*"
            label="Add non-project arc:"
          />
